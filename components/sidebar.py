...
def render_sidebar():
    """Affiche la sidebar et retourne l'item de navigation sélectionné."""
    with st.sidebar:
        ...
        st.markdown(
            ...
            f'<div style="font-size:12px;color:#4A6080;margin-bottom:6px;">👤 {username}</div>'
        ...
        nav_items = [_("nav_dashboard"), _("nav_workspace"), _("nav_archives"),
                     _("nav_compte"), _("nav_params"), _("nav_legal")]
