...
Version 7.0 (mai 2026)

Structure PDF expert V7 :
  Page 1 — Couverture
  Page 2 — Synthese KPIs + Scoring
  Page 3 — Analyse IA prescriptive
  PAS de page graphiques (graphs dans le dashboard)
  PAS de page CTA (CTA uniquement dans le PDF gratuit — Regle 10)
"""
...
def generate_expert_pdf(title, content, figs=None, kpis=None, labels=None, module="stock"):
    ...
    # V7 : Pas de page graphiques dans le PDF. Les graphiques restent dans le dashboard Streamlit.
    # Le parametre figs est conserve dans la signature pour compatibilite logiflo_app.py.
    ...
    # V7 Regle 10 : Pas de page CTA dans le PDF expert/pro.
    # La phrase "Logiflo..." n'apparait QUE dans generate_free_pdf.
