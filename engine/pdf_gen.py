# -*- coding: utf-8 -*-
"""
Logiflo - engine/pdf_gen.py
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Generation PDF (audit gratuit + expert) + predictions ruptures + BFR
Version 6.1 (mai 2026) — espacements resserres pour rendu pro

Corrections V6.1 (cosmétiques uniquement, zéro changement fonctionnel) :
- Espace après KPI cards : 46 → 34
- Scoring bars : 8 → 6
- Charts hauteur : 84 → 72, gap : +6 → +4
- Section ### : avant 5→3, après 4→3
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
...
def generate_free_pdf(module, summary_text, kpis, labels):
    ...
    pdf.cell(0,6,"logiflo.io  |  contact@logiflo.io",ln=True)
...
def generate_expert_pdf(title, content, figs=None, kpis=None, labels=None, module="stock"):
    ...
    if _details_pdf:
        for _dim_label, _sv in list(_details_pdf.items())[:3]:
            ...
            pdf.ln(6)  # V6.1: resserré (était 8)
    ...
    content_r = (content or "").replace("\u2019","'").replace("\u2018","'").replace("\u201c",'"').replace("\u201d",'"').replace("\u20ac","EUR").replace("\u2022","-").replace("\u2013","-").replace("\u2014","-")
    _in_scoring = False
    ...
    if lang == "en":
        cta_lines = [("This report was generated by LOGIFLO.IO",True,255),("",False,200),("Designed by a field logistics professional.",False,200),("Not by a consultant.",False,200),("",False,200),("To go further :",True,255),("contact@logiflo.io",False,150),("logiflo.io",False,150)]
    else:
        cta_lines = [("Ce rapport a ete genere par LOGIFLO.IO",True,255),("",False,200),("Concu par un logisticien terrain.",False,200),("Pas par un consultant.",False,200),("",False,200),("Pour aller plus loin :",True,255),("contact@logiflo.io",False,150),("logiflo.io",False,150)]
